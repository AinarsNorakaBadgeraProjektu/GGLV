...
Config.LevelRestrict = { Enable = true, Level = 3 } -- If you want to restrict when a player can buy a rat, you can set this to true and specifiy the level
...
-- exports['gglv-dumpsters']:openRatMenu()
-- event: gglv-dumpsters:client:openRatMenu
Config.CreateExportForMenu = {
    ...
    OnlyAllowPurchaseAtKing = true, -- If set to false, allow purchase from the menu when opening it via the export and not the hobo king. If set to true then you can buy a rat remotely.
}

-- exports['gglv-dumpsters']:callRat()
-- event: gglv-dumpsters:client:callRat
...
Config.PriceForRat = 50 -- Price to purchase a Rat.
...
Config.RatPerks = {
    ...
    -- So for example, if you have set the boost for level 1 to 1 and you've levelled the perk to level 1 and the quantities in an expedition for chewinggum is 2, then that value will be amplified to 3 and so on.
...
Config.RatExpeditions = {
    {
        ...
        Loot = {
            Amount = math.random(2, 3), -- The amount of stuff listed in items to pick from. i.e. if Amount is 2 then it'll choose 2 entries in the Items table to give you
            Items = {
                { name = 'chewinggum', quantity = math.random(5, 9), chance = 50, xp = 5 }, -- item, quantity of said item that you get, chance as opposed to others, additional xp your rat gets if this item is chosen (xpReward + this)
                { name = 'tissuebox', quantity = math.random(4, 10), chance = 30, xp = 5 }, -- item, quantity of said item that you get, chance as opposed to others, additional xp your rat gets if this item is chosen (xpReward + this)
                { name = 'bobbypin', quantity = math.random(4, 10), chance = 20, xp = 5 } -- item, quantity of said item that you get, chance as opposed to others, additional xp your rat gets if this item is chosen (xpReward + this)
            },
            RareItem = { -- 
                Enable = true, -- true/false enable rare drops
                Quantity = math.random(1, 1), -- Quantity
                Chance = 2, -- Chance of receiving a rare item(s)
                Items = {
                    { name = 'lockpick', quantity = 1, xp = 50 } -- item, quantity of said item that you get, chance as opposed to others, additional xp your rat gets if this item is chosen
                },
            }
        }
    },
    {
        ...
        Loot = {
            ...
            Items = {
                { name = 'bobbypin', quantity = math.random(4, 10), chance = 40, xp = 5 },
                { name = 'fuelcap', quantity = math.random(4, 10), chance = 30, xp = 10 },
                { name = 'chewinggum', quantity = math.random(4, 10), chance = 30, xp = 10 }
            },
            RareItem = {
                ...
                Quantity = math.random(1, 1), -- Quantity
                Items = {
                    { name = 'rustynails', quantity = 1, xp = 20 }
                },
            }
        }
    },
    {
        ...
        Loot = {
            ...
            Items = {
                { name = 'chewinggum', quantity = math.random(4, 10), chance = 45, xp = 5 },
                { name = 'tissuebox', quantity = math.random(4, 10), chance = 35, xp = 5 },
                { name = 'fuelcap', quantity = math.random(4, 10), chance = 20, xp = 5 }
            },
            RareItem = {
                Enable = true, -- Enable Rare Items
                Chance = 2, -- Chance of receiving a rare item(s)
    ...
    },
    {
        ...
        Loot = {
            Amount = math.random(2, 3),
            Items = {
                { name = 'tissuebox', quantity = math.random(4, 10), chance = 40, xp = 5 },
                { name = 'chewinggum', quantity = math.random(4, 10), chance = 40, xp = 5 },
                { name = 'bobbypin', quantity = math.random(4, 10), chance = 20, xp = 5 }
            },
            RareItem = {
                Enable = true, -- Enable Rare Items
    ...
    },
    {
        ...
        Loot = {
            ...
            Items = {
                { name = 'bobbypin', quantity = math.random(4, 10), chance = 40, xp = 5 },
                { name = 'tissuebox', quantity = math.random(4, 10), chance = 30, xp = 5 },
                { name = 'fuelcap', quantity = math.random(4, 10), chance = 30, xp = 5 }
            },
            RareItem = {
                Enable = true, -- Enable Rare Items
                Chance = 5, -- Chance of receiving a rare item(s)
    ...
    },
    {
        ...
        Loot = {
            ...
            Items = {
                { name = 'tissuebox', quantity = math.random(4, 10), chance = 35, xp = 5 },
                { name = 'chewinggum', quantity = math.random(4, 10), chance = 35, xp = 5 },
                { name = 'bobbypin', quantity = math.random(4, 10), chance = 30, xp = 5 }
            },
            RareItem = {
                Enable = true, -- Enable Rare Items
                Chance = 5, -- Chance of receiving a rare item(s)
    ...
    },
    {
        ...
        Loot = {
            Amount = math.random(2, 4),
            Items = {
                { name = 'bobbypin', quantity = math.random(4, 10), chance = 35, xp = 5 },
                { name = 'tissuebox', quantity = math.random(4, 10), chance = 35, xp = 5 },
                { name = 'fuelcap', quantity = math.random(4, 10), chance = 30, xp = 5 }
            },
            RareItem = {
    ...
    },
    {
        ...
        Loot = {
            Amount = math.random(2, 4),
            Items = {
                { name = 'chewinggum', quantity = math.random(4, 10), chance = 30, xp = 5 },
                { name = 'tissuebox', quantity = math.random(4, 10), chance = 30, xp = 5 },
                { name = 'fuelcap', quantity = math.random(4, 10), chance = 40, xp = 5 }
            },
            RareItem = {
                Enable = true, -- Enable Rare Items
                Chance = 10, -- Chance of receiving a rare item(s)
                Quantity = math.random(1, 1), -- Quantity
                Items = {
                    { name = 'bobbypin', quantity = 1, xp = 20 }
                },
            }
        }
    },
    {
        ...
        Loot = {
            Amount = math.random(2, 4),
            Items = {
                { name = 'chewinggum', quantity = math.random(10, 30), chance = 25, xp = 5 },
                { name = 'tissuebox', quantity = math.random(10, 30), chance = 25, xp = 5 },
                { name = 'fuelcap', quantity = math.random(10, 30), chance = 25, xp = 5 }
            },
            RareItem = {
                Enable = true, -- Enable Rare Items
                Chance = 10, -- Chance of receiving a rare item(s)
