...
Config.MinCops = 2 --Minimum cops on duty
Config.CopsChance = 0.7 --Chance of cops being called, ranges from 0.0 to 1.0
Config.Dispatch = 'qs-dispatch' --Choose 'ps-dispatch' or 'cd_dispatch'
Config.Framework = 'qb' --Options: 'qb' (qb-core), 'qbx' (qbox)

Config.ScrapTime = 2500 --Time in miliseconds to steal scraps
...
Config.ScrapObjects = {
    {
        ...
        ['rewards'] = {
            {['item'] = 'metalfrags', ['min'] = 3, ['max'] = 6, ['weight'] = 35},
            {['item'] = 'copperwire', ['min'] = 1, ['max'] = 2, ['weight'] = 25},
            {['item'] = 'steel', ['min'] = 1, ['max'] = 5, ['weight'] = 30},
            {['item'] = 'broken_keypad', ['min'] = 1, ['max'] = 1, ['weight'] = 10}
        },
    },
    {
