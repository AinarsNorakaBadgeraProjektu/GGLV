Config = {
    ...
    NPCModels = {
        "g_m_m_chicold_01", "csb_brucie2", "g_m_y_korean_02", "csb_vincent"
    }, -- Setup the npc model name (Can be retrieve here : https://docs.fivem.net/docs/game-references/ped-models/)
    ...
    TimeWhenWarCanStart = { -- Add any time range where you want to allow start war (24H time range from server). To be able to run time range from 21 to 02 you need to do two time rules like in this example below. H for hour m for minute
        { beginWar = {h = 20, m = 0}, endWar= {h = 24, m = 0} },
    ...
    OrganizationCooldown = 30, -- Time in minutes after which player can start another zone war
    ZoneCooldown = 30, -- Time in minutes after which all players can start another war in the same zone

    CurrencyAward = 100, -- Amount of special currency awarded to each criminal when the organization win the war
    Rewards = { -- Reward send to player when they win the war. Can be fixed amount or random amount ({0,5} will be a random from 0 no obejct to 5 object)
        ['largecrate'] = 1,
        ['bitcoin'] = 50,
        ['phantomcrate'] = {0, 1} -- Random reward from 0 to max 3
    },
    ...
    ---------------------------
    CanCreateOrganizations = false, -- Allow player to create organizaiton from UI (if false, you will need to use the command to create it)
    ...
    CircleShape = true, -- Circle shape
    DiamondShape = false, -- Diamond shape
    ...
    Zones = {
        ...
        [7617] = {
            Title = 'OXY HARVEST',
            Picture = 'https://gglv.lv/main/img/oxy1.png',
            Description = {
                'Generates oxy every 5 minutes.',
                'Includes a storage box to collect produced items directly.'
            },
            ...
            Storages = { -- storage unit to handle items, can be multiple, and each storage will receive the items
                ['generation-storage01'] = { -- name of the storage, need to be unique accros ALL THE ZONE and HOUSE ZONE, don't forget to change it on your new zone
                    ...
                    Coords = vector3(-315.8, -2698.39, 7.55 - 0.98), -- -0,98 to remove character height
                    Prop = 'prop_weed_tub_01', -- props model that will handle target to open storage
                    Rotation = 100,
                    slot = 2, -- weight inventory integration
                    maxWeight = 5000, -- weight inventory integration
            ...
            NPCs = {
                ['mp_m_weed_01'] = {
                    Coords = vector3(-314.88, -2699.47, 7.55 - 0.98),
                    Rotation = 313.7270,
            ...
            Time = 300000, -- Time in miliseconds after which item will be generated

            -- Set specific NPC model that will spawn for this zone when protection will be increase
            NPCModels = {
                'mp_f_weed_01', 'mp_m_weed_01', 'g_m_y_mexgoon_01',
                ',g_m_y_famfor_01', 'g_f_importexport_01', 'a_f_y_hippie_01'
            },
        ...
        [6904] = {
            Title = 'COCAINE SALES',
            Picture = 'https://gglv.lv/main/img/coke.png',
            Description = {
                'Sell cocaine every 5 minutes',
                'Put bag or brick of cocaine into the storage to get currency in exchange every 5 minutes'
            },
            ...
            Storages = {
                ['sales-storage01'] = {
                    InventoryType = 'stash',
                    Coords = vector3(-569.67, -1689.72, 19.54 - (2 * 0.98)),
                    Rotation = 301.7923,
                    ...
                    animName = 'base',
                    slot = 2, -- slot inventory integration
                    maxWeight = 10000, -- weight inventory integration
                    OnlyOwnerCanAccessStorage = false -- true : only owner can access the storage, false : all members can
                }
            },
            ...
            SalesItems = {
                {
                    SaleItem = 'coke', -- Item required in the storage that will be sell
                    ...
                    SaleItem = 'cocainebaggy', -- Item required in the storage that will be sell
                    SaleAmount = 1, -- Amount required in the storage that will be sell
                    SalePriceForAmount = 5 -- Amount of currency put in exchange in the storage when the amount of items will be sell
                }
            },

            Time = 300000 -- Time in miliseconds after which item will be sold
            -- Amount of players in the organisation that need to be online to attack an owned zone by another organization
            -- (if organization members (offline and online) are less than this number, it won't be check),
            -- OrganizationMembersRequiredOnlineToAttackZone = 5,
        },
        [3211] = {
            Title = 'WEED SALES',
            Picture = 'https://gglv.lv/main/img/weed.png',
            Description = {
                'Sell Weed every minute',
            ...
            Storages = {
                ['sales-storage01'] = {
                    InventoryType = 'stash',
                    Coords = vector3(1832.61, 3735.41, 34.46 - (2 * 0.98)),
                    Rotation = 287.7923,
                    Npc = 's_m_y_dealer_01', -- NPC model that will handle target to open storage
                    animDict = 'amb@code_human_in_bus_passenger_idles@male@sit@base',
                    animName = 'base',
            ...
            SalesItems = {
                {
                    SaleItem = 'joint', -- Item required in the storage that will be sell
                    SaleAmount = 1, -- Amount required in the storage that will be sell
                    SalePriceForAmount = 4 -- Amount of currency put in exchange in the storage when the amount of items will be sell
                }, {
                    SaleItem = 'weedbrick', -- Item required in the storage that will be sell
                    SaleAmount = 1, -- Amount required in the storage that will be sell
                    SalePriceForAmount = 55 -- Amount of currency put in exchange in the storage when the amount of items will be sell
                }
            },
        ...
        [6917] = {
            Title = 'MONEY WASH',
            Picture = 'https://gglv.lv/main/img/money.png',
            Description = {
                'Converts dirty money into clean cash.',
                'Operate carefully — transactions take time.'
            },

            Type = 'processing', -- processing, sales, storage, generation

            Storages = { -- storage unit to handle items, can be multiple
                ['processing-storage02'] = { -- name of the storage, need to be unique accros ALL THE  and HOUSE ZONE, don't forget to change it on your new zone
                    InventoryType = 'stash',
                    Coords = vector3(944.62, -1697.66, 30.09 - 0.98),
                    Prop = 'prop_weed_tub_01', -- props model that will handle target to open storage
                    Rotation = 248.1330,
                    slot = 2, -- slot inventory integration
                    maxWeight = 1000, -- weight inventory integration,
                    OnlyOwnerCanAccessStorage = false -- true : only owner can access the storage, false : all members can
                }
            },
            ...
            NPCs = {
                -- ['mp_f_meth_01'] = {
                --     Coords = vector3(944.37, -1699.37, 30.09 - 0.98),
                --     Rotation = 248.9632,
                --     animDict = 'amb@world_human_leaning@female@coffee@idle_a',
                --     animName = 'idle_a'
                -- },
                -- ['mp_m_meth_01'] = {
                --     Coords = vector3(944.64, -1696.2, 30.09 - 0.98),
                --     Rotation = 239.3278,
                --     animDict = 'amb@world_human_leaning@female@coffee@idle_a',
                --     animName = 'idle_a'
                -- },
            ...
            ProcessingItems = {
                {
                    ProcessingFromItem = 'markedbills', -- item required in the storage that will be transform
                    ProcessingFromItemAmount = 1, -- amount item required that will be transform
                    ProcessingToItem = 'cash', -- item that will be add in exchange of the item required
                    ProcessingToItemAmount = 2 -- amount of item that will be add in the storage when transform
                }
            },
            Time = 10000 -- Time in miliseconds after which item will be processed
    ...
    HouseZones = {
        ...
        [7067] = {
            ...
            Picture = 'https://gglv.lv/main/img/ballashood.png',
            Description = {
            ...
            Storages = {
                ['house-storage01'] = {
                    ...
                    Rotation = 49.1725,
                    slot = 20, -- slot inventory integration
                    maxWeight = 250000, -- weight inventory integration
                    OnlyOwnerCanAccessStorage = false
                }
            },
            -- Set specific NPC model that will spawn for this zone when protection will be increase
            NPCModels = {
                'csb_ballasog', 'g_f_y_ballas_01', 'g_m_y_ballasout_01',
                ',ig_ballasog', 'g_m_y_ballaeast_01', 'g_m_y_ballaorig_01',
                'g_m_y_ballasout_01'
            },
            -- Set specific NPC weapon that will give to npc to the npc for this zone when protection will be increase
        ...
        [6828] = {
            Title = 'Families Hood',
            Picture = 'https://gglv.lv/main/img/familieshood.png',
            Description = {
                'Gang house with storage',
                'Provide a secure storage for your gang'
            },
            ...
            Storages = {
                ['house-storage02'] = {
                    InventoryType = 'stash',
                    Coords = vector3(-173.87, -1563.24, 35.36 - 0.98),
                    Prop = 'prop_weed_tub_01',
                    Rotation = 48.4206,
                    slot = 20, -- slot inventory integration
                    maxWeight = 250000, -- weight inventory integration
        ...
        [7148] = {
            ...
            Picture = 'https://gglv.lv/main/img/vagoshood.png',
            Description = {
                'Gang house with storage',
                'Provide a secure storage for your gang'
            },
        ...
        [6842] = {
            ...
            Picture = 'https://gglv.lv/main/img/marabunteshood.png',
            Description = {
                'Gang house with storage',
                'Provide a secure storage for your gang'
            },
        ...
        [6833] = {
            Title = 'Aztecas Hood',
            Picture = 'https://gglv.lv/main/img/aztecashood.png',
            Description = {
                'Gang house with storage',
                'Provide a secure storage for your gang'
            },
            ...
            Storages = {
                ['house-storage05'] = {
                    InventoryType = 'stash',
                    Coords = vector3(449.29, -1559.63, 29.28 - 0.98),
                    Prop = 'prop_weed_tub_01',
                    Rotation = 84.7873,
                    slot = 20, -- slot inventory integration
                    maxWeight = 250000, -- weight inventory integration
    ...
    Continentals = {
        ...
        [8025] = {
            ...
            Shop = {
                ['items'] = {['armor'] = 100, ['at_suppressor_light'] = 600, ['at_flashlight'] = 200}, 
                ['weapons'] = {['weapon_knife'] = 50, ['weapon_pistol'] = 500, ['at_clip_extended_pistol'] = 400}
            },
