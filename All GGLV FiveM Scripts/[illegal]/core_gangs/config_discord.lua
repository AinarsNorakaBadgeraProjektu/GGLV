ConfigDiscord = {
    DiscordLogEnable = true, -- to enable the discord logs.

    DiscordMsgColor = 990000, -- Color of the message 
    DiscordUsername = 'GGLV', -- Name of the sender
    DiscordAvatar   = 'https://gglv.lv/main/img/logo.png', -- Avatar link of the sender
    ...
    DiscordLogs = {
        ...
        ['OrganizationJoined'] = {
            Enable = true,
            ChannelWebHook = 'https://discord.com/api/webhooks/1416137929537093764/r95tocEqGGWezBzqi29orcSXJUHVSNuTRkxkbjtCqooop9C6kfeNOTgJkxPi2Bx_nPFu',
            Title = '**Player joined a gang**',
        ...
        ['OrganizationLeaved'] = {
            Enable = true,
            ChannelWebHook = 'https://discord.com/api/webhooks/1416138192591257711/zGqNPbfUs5H4m_EcPBzCzy1DdVjMHjt1IZBI_xPtmEkiepgI5CL2GBU_IvEbp8SOS9Sg',
        ...
        ['WarStart'] = {
            Enable = true,
            ChannelWebHook = 'https://discord.com/api/webhooks/1416138338091536537/dgdtJGKrpZTy6WwqNsyQU-g-uiTCO1hNGqxb93IzOvI-tCp6Wq-0x0r2ybNd-jJCLxRV',
            Title = '**War start**',
        ...
        ['CriminalsCreated'] = {
            Enable = true,
            ChannelWebHook = 'https://discord.com/api/webhooks/1416138848710299728/VpdiLtTfWErhJRlDbbX127kASPf-hrtSQheGefZO4OM3HyNC-HUBFoCASSwWzqKF0U8z',
