...
Config['OilRigHeist'] = {
    ...
    ["dispatch"] = "qs-dispatch", -- cd_dispatch | qs-dispatch | ps-dispatch | rcore_dispatch | default
    ...
    ['startHeist'] ={ -- Heist start coords
        pos = vector3(-730.89, 309.64, 85.1),
        peds = {
            {pos = vector3(-730.89, 309.64, 85.1), heading = 21.85, ped = 's_m_m_highsec_01'},
            {pos = vector3(-731.08, 310.68, 85.11), heading = 111.78, ped = 's_m_m_highsec_02'},
            {pos = vector3(-731.34, 308.46, 85.09), heading = 292.42, ped = 's_m_m_fiboffice_02'}
        }
    },
    ['requiredPlayersForHeist'] = 1, -- Required players for start heist.
    ['crateSettings'] = {
        ['crateCount'] = 10, -- Crate with items count for every heist. (Max 10)
        ['crateItems'] = { -- Items for every crate.
            {itemName = 'weapon_pistol',   itemCount = function() return math.random(1, 1) end, chance = 5},
            {itemName = 'cash',  itemCount = function() return math.random(10000, 50000) end, chance = 50},
            {itemName = 'phantomcrate',  itemCount = function() return math.random(1, 1) end, chance = 30},
            {itemName = 'jewlerycrate',  itemCount = function() return math.random(1, 1) end, chance = 30},
            {itemName = 'bobcatcard',  itemCount = function() return math.random(1, 1) end, chance = 100},
        },
        ['lootTime'] = 20, -- Seconds
    }
}
...
Config['OilRigSetup'] = {
    ...
    ['guards'] = { 
        ...
        ['weapons'] = {'WEAPON_PISTOL', 'WEAPON_ASSAULTSMG',} -- You can change this.
    },
    ['crates'] = {
...
Strings = {
    ['wait_nextrob'] = 'You have to wait this long to go again',
    ['minute'] = 'minute.',
