...
Config.Start = {
    ...
    locations = {
        vec4(1310.95, -514.59, 71.31, 338.92),
        vec4(896.83, -2533.99, 28.3, 230.1),
        vec4(-1563.18, -441.33, 36.98, 108.73),
        vec4(1091.56, 82.42, 80.89, 52.1),
        vec4(-271.39, -698.24, 38.28, 153.43),
        vec4(-28.98, -18.64, 69.0, 290.4),
