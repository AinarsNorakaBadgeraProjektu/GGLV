return {
	Weapons = {
		...
		['WEAPON_FLATHEAD_SCREWDRIVER'] = {
			label = 'Flathead Screwdriver',
			weight = 0,
			durability = 0.1,
		},
		['WEAPON_RATCHET_WRENCH'] = {
			label = 'Ratchet Wrench',
			weight = 0,
			durability = 0.1,
		},
		...
		['WEAPON_FURY_PICKAXE_IRON'] = { 
			...
			weight = 1000,
			durability = 0.01, -- Lasts approximately 100 uses (1.0 / 0.01 = 100)
		},
		
		['WEAPON_FURY_PICKAXE_STONE'] = {
			label = 'Hand Made Pickaxe',
			weight = 1000,
			durability = 0.04, -- Lasts approximately 25 uses (1.0 / 0.04 = 25)
		},
		...
		['WEAPON_PUMPSHOTGUN'] = {
			label = 'Rubber Bullet Shotgun',
			weight = 3400,
			durability = 0.1,
			ammoname = 'ammo-rubberbullets'
		},
