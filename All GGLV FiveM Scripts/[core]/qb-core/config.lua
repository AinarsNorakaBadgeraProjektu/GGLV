...
QBConfig.MaxPlayers = GetConvarInt('sv_maxclients', 50) -- Gets max players from config file, default 48
...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 750, bank = 0, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
QBConfig.Money.DontAllowMinus = { 'cash', 'crypto', 'bank' }                -- Money that is not allowed going in minus
QBConfig.Money.MinusLimit = -1                                    -- The maximum amount you can be negative 
...
QBConfig.Player.PlayerDefaults = {
    ...
    metadata = {
        ...
        licences = {
            ...
            drive_c = false,
            theory_boat = false,
            practical_boat = false,
            theory_helicopter = false,
            theory_plane = false,
            practical_helicopter = false,
            practical_plane = false,
            business = false,
            weapon = false
        },
        inside = {
