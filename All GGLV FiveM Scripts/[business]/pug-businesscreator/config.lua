...
------------------------------
---------- [STRINGS] ----------
Config.inventoryImagesDirectoryPath = "nui://ox_inventory/web/images" -- Image directory path to your inventory script so that images can be saved to it when you make new items.
...
Config.BusinessCommission = 0.90 -- (%) 30 % is the commision that goes to the business of each register sale
...
------------------------------
---------- [TRAYS] ----------
Config.CounterTopTreySize = 5000 -- How much wight the counter top treys can hold. (Default is 100)
Config.CounterTopTreySlots = 10 -- How many item slots the counter top treys can hold. (Default is 10)
------------------------------
---------- [STORAGE] ----------
Config.BusinessStorageSize = 400000 -- How much wight the businesses storage can hold. (Default is 1000)
