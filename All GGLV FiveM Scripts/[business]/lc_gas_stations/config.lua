...
Config.enable_different_fuels = false			-- Enable / disable the tabs with Plus, Premium, Diesel and Electric fuel types.
...
Config.gas_station_locations = {
	["gas_station_1"] = {												-- ID
		['buy_price'] = 900000,											-- Price to buy this gas station
	...
	["gas_station_25"] = {
		...
		['truck_coord'] = {-711.32, -942.01, 19.25, 185.67},
		['trailer_coord'] = {-707.55, -935.93, 19.01, 179.26},
...
Config.gas_station_types = {
	['small_gas_station'] = {					-- Gas station type ID
		...
		['stock_capacity'] = 1000,				-- Maximum stock capacity per fuel type
		['min_gas_price'] = 3.0,					-- Minimum price that the owner can apply
		['max_gas_price'] = 100,					-- Maximum price that the owner can apply
		['electric_normal_price'] = 3000,		-- Price to unlock normal chargers
		['electric_fast_price'] = 9000,			-- Price to unlock fast chargers chargers
		...
		['ressuply_deliveryman'] = {					-- Driver contracts
			...
			['price_per_liter'] = 4.0					-- Standard price per contract liter
		},
		['ressuply'] = {								-- Definition of contracts for the owner
			[1] = {
				['name'] = 'Small cargo',				-- Name in contract
				['price_per_liter_to_import'] = {		-- Price per liter to import each fuel type
					['regular'] = 3.0,
					['plus'] = 3.0,
					['premium'] = 3.5,
					['diesel'] = 2.5,
				},
				['price_per_liter_to_export'] = {		-- Price per liter to export each fuel type
					['regular'] = 8.9,
					['plus'] = 3.2,
					['premium'] = 3.7,
					['diesel'] = 2.7,
			...
			[2] = {
				['name'] = 'Medium cargo',
				['price_per_liter_to_import'] = {
					['regular'] = 3.0,
					['plus'] = 3.0,
					['premium'] = 3.0,
					['diesel'] = 2.5,
				},
				['price_per_liter_to_export'] = {
					['regular'] = 8.5,
					['plus'] = 3.2,
					['premium'] = 3.7,
					['diesel'] = 2.7,
...
Config.clear_gas_stations = {
	...
	['cooldown'] = 168				-- Time (in hours) that the gas station needs to be below the minimum amount of stock to be removed
}
