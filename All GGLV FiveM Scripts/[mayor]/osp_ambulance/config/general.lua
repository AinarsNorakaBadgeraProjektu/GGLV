...
Config.webHook = 'https://discord.com/api/webhooks/1354507348525453352/ttpYIGRRvyBRr3L--_sbiLm_DZhSHTwTTUkc7YooJyaJIMh6KXexeZU8f_fXXUossk4O'
...
Config.Helicopter = "dlswift" -- Helicopter model that players with the ambulance job can use
Config.BillCost = 850 -- Price that players are charged for using the hospital check-in system
Config.LastStandTime = 180 -- How long before the player is percived as medically dead (in seconds)
...
Config.inLastStandHealth = 150 -- MUST BE ABOVE ZERO 0, The health the player should have when they are in last stand
...
Config.LockMedicalMenu = false -- Set to true if you want to lock the whole medical menu to only be opened by EMS
