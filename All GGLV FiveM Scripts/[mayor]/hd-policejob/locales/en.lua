local Translations = {
    error = {
        ...
        deactivated = 'GPS is deactivated',
        norecords = 'There are no records',
        validnumber = 'Needs to be a valid number',
        handsup = 'The hands are not up or cuffed!'
    },
    success = {
    ...
    info = {
        ...
        vehicle_info = 'Bill: $%{billvalue} | Engine: %{value} % | Fuel: %{value2} %',
        ...
        unknown = 'Unknown',
        select_for_examine_b = 'Street: %{street} | Label: %{label} | Slot: %{slot}',
    ...
    radar = {
        ...
        r_keys = '[Arrows] Move Zone | [F] Place Zone'
    },
    fingerscan = {
        title = 'Fingerprint'
    },
    polmenu = {
        ...
        actions = 'Action Menu',
        traffic_menu = 'Traffic Menu',
        actionheader = 'LEO Actions',
        checkstatus = 'Check Status',
        escort = 'Escort Player',
        search = 'Search Player',
        jail = 'Jail Player',
        resetlock = 'Reset house lock',
        takedl = 'Take Driver License',
        trafficheader = 'Traffic Control',
        slowtraffic = 'Slow Traffic',
        stoptraffic = 'Stop Traffic',
        onlyone = 'Only one traffic zone allowed',
        cammenu = 'Camera Menu',
        openbcam = 'View Bodycam',
        openbcamdesc = 'View Active Body Camera\'s',
        opendcam = 'View Dashcam',
        opendcamdesc = 'View Active Dash Camera\'s',
        openrecords = 'View Recordings',
        openrecordsdesc = 'View Saved Cam Records',
        activecammenu = 'Active Camera\'s',
        back = 'Go back',
        putinveh = 'Put in vehicle',
        takeoutveh = 'Take out from vehicle',
        viewcam = 'View static camera',
        viewcamdesc = 'View static cameras around the city',
        camid = 'Camera ID',
        takegsr = 'Take GSR',
        flagplate = 'Flag Plate',
        platetoflag = 'Plate to flag',
        reason = 'Reason',
        flagplateinfo = 'Get flagged plates',
        unflag = 'Unflag',
        unflagdesc = 'Unflag the chosen plate'
    },
    notifyheaders = {
        camera = 'Camera',
        evidence = 'Evidence',
    ...
    bodydash = {
        ...
        rec_notremoved = 'Recording could not be removed!',
