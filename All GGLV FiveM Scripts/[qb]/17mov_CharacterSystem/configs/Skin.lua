...
Skin.BlacklistedInputValues = { -- Here you can blacklist some clothes (inputs values)
    [`mp_m_freemode_01`] = {
         ["torso2"] = { 561,562,563,564,565,566,567,569,570,571,573,574,575,576,577,578,579,580,594,595,596,597,598,599,600,601,609,610,611 },
         ["hat"] = { 261,259,246,245,243,242,241,240,238,236,235,234,47 },
         ["pants"] = { 214,213,212,211,209,206},
    },
    [`mp_f_freemode_01`] = {
        ["torso2"] = { 716,715,714,713,710,709,699,698,697,696,695,694,693,680,666,665,664,663,662,661,659,627,619,618,617,616,541,331,330,329,328,327,258,48 },
        ["pants"] = { 234,233,232, 226,225,223,187,136,135,99 },
        ["hat"] = { 240,239,238,235,234,233,232,231,230,46 },
    },
}
