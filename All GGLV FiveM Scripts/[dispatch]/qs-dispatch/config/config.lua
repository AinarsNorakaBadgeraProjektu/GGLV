...
Config.DiscordWebHook = 'https://discord.com/api/webhooks/1404880346595590276/_lhG1fPyGyN775Ex7F3Qs1G4vPe-xjbsi0hr-Q9pVgDDKipLyb7SWt9adMyjmjiM-B2U'                                                                                                              -- Discord webhook to upload new images
...
Config.SPEED_ZONE_RADIUS = 4.0

---- ANTICHEAT ----
Config.FiveguardName = "fiveguard"
---- ANTICHEAT ----

Config.InventorySystem = "ox-inventory" -- qb-inventory or qs-inventory or esx-default you can select ox-inventory but this is not fully tested
...
--[[
    ...
    By default choose:
        'esx' -- for ESX servers,
        'qb-core' -- for QBCore servers,
]]

Config.VehicleGarages = GetResourceState('qb-core') == 'started' and 'qb-core' or GetResourceState('es_extended') == 'started' and 'esx' or 'esx'
...
Config.JobsBlips = {              -- Blips for players depending on their job
    ['police'] = {                --JOB
        ...
        showJobs = {
            'ambulance','firefighter' -- need Exist Blip config in this section
        },
        scale = 1.0,    -- Scale
        showConeOfView = true,
    },
    ['ambulance'] = {             --JOB
        ...
        showJobs = {
            'police','firefighter' -- need Exist Blip config in this section
        },
        scale = 1.0, -- Scale
    ...
    ['firefighter'] = {             --JOB
        ...
        showJobs = {
            'police','ambulance' -- need Exist Blip config in this section
        },
        scale = 1.0, -- Scale
        showConeOfView = false,
    },
...
Config.Dispatch = {
    EnabledRadios = false,
    ['police'] = {
        DefaultChannel = 1, -- Default channel for the police
        Groups = {
            {
                id = 1,
                name = "Central Police Department",
                description = "Patroling",
                radiochannel = 1,
            },
            {
                id = 2,
...
Config.VelocityRadar = {      -- Velocity Radar Config
    enabled = false,           -- Enable velocity Radars in the map
