...
local function suspiciousDigging()
    local playerData = exports['qs-dispatch']:GetPlayerInfo()
    ...
    TriggerServerEvent("qs-dispatch:server:CreateDispatchCall",
        {
            job = "police",
            callLocation = playerData.coords,
            callCode = { code = "10-15", snippet = "Suspicious Digging" },
            message = 'A ' .. playerData.sex .. ' is digging at the cemetery.',
            flashes = false,
            image = nil,
            blip = {
                sprite = 378,
...
exports('suspiciousDigging', suspiciousDigging)
...
-- CivilianRobbery
local function CivilianRobbery()
    local playerData = exports['qs-dispatch']:GetPlayerInfo()
    ...
    TriggerServerEvent("qs-dispatch:server:CreateDispatchCall",
        {
            job = "police",
            callLocation = playerData.coords,
            callCode = { code = "10-31", snippet = "Civilian Robbery" },
            message = 'A' .. playerData.sex .. ' is robbing a civilian near ' .. playerData.street_1 .. '.',
            flashes = false,
            image = nil,
            blip = {
                sprite = 409,
                ...
                colour = 1,
                flashes = false,
                text = "Civilian Robbery Call",
                time = (3 * 60 * 1000),
            },
            otherData = {
                {
                    text = 'Civilian Robbery',
                    icon = 'fas fa-cannabis',
                }
            }
        }
...
exports('CivilianRobbery', CivilianRobbery)
