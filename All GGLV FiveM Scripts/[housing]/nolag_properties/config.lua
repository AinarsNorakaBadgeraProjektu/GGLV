Config = {
    ...
    PropertyPrice = { 1, 3000000 },              -- The price of the property, first number is the minimum, second is the maximum.
    ...
    InactivityDays = 5,                         -- The amount of days before a property is considered inactive and set for sale (If you want to disable you can just set it to false)
    InactivityDaysForRent = 5,                  -- The amount of days before a property is considered inactive and auto renew is disabled (If you want to disable you can just set it to false)
    ...
    --[[ Selling ]]
    SellPercentage = 60, -- The percentage of the property price the owner will get back when selling it to the government (default: 70 %)
    ...
    MaxRentDays = 14,                 -- Maximum number of days a property can be rented for (default: 10)
