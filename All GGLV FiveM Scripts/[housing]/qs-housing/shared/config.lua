...
-- General use for money type it doesn't mean that all pricing will be from here. Only for things that interact with the player. Big things like Rent will still only use “bank”.
Config.MoneyType = 'bank' -- 'money', 'bank'
...
--[[
	Available options for society systems:
		- none
		- esx_society
		- ap-government
		- qb-management
...
Config.Society = 'qb-banking'       -- Select your society system (above you have the list)
...
Config.OpenHouseMenu = 'F3'                   -- Key to open the internal menu of the home set false if you don't want to use it
Config.OpenJobMenu = 'F7'                     -- Key to open the house creation menu set false if you don't want to use it
