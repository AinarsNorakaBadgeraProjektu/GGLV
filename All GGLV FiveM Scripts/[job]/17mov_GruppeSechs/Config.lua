...
Config.RequiredJob = "gruppesechcsjob"             -- Set to "none" if you dont want using jobs. If you are using target, you have to set "job" parameter inside every export in target.lua
...
Config.JobCooldown = 45 * 60 -- 10 * 60            -- 0 minutes cooldown between making jobs (in brackets there's example for 10 minutes)
...
Config.EnableInteriorRefreshing = false              -- Experimental feature for those who have issues with crashses. Disable to fix crashses. May result in script unexpected work

Config.RewardItemsToGive = {
    {
        item_name = "fleeca_bankcard",
        chance = 40,
        amount = 1,
    },
    {
        item_name = "transponder",
        chance = 5,
        amount = 1,
    },
}
...
Config.EnableEnteringCodeAnim = false                -- Set to false if you're using some custom MLO, and the anim dosen't looks good for u
...
Config.MinimumCopsToStartHeist = 4              -- Set Minimum cops on duty count required to start heist
Config.RequiredSecondsToFetch = 60              -- The time in seconds that is required to take control of a cash transport
...
Config.AtmsLocations = {
    ...
    [2] = { coords = vector4(140.1594, -1042.3051, 28.2630, 161.7462) },
...
Config.Blips = { -- Here you can configure Company blip.
    [1] = {
        ...
        Color = 69,
        Scale = 0.8,
        Pos = vector3(-194.62, -833.91, 30.76),
        Label = 'Gruppe6 Job'
    },
}
...
Config.SpawnPoint = vector4(-143.65, -821.66, 31.33, 69.33)    -- Company car spawn point
...
Config.BankLocations = {
    ...
    [2] = {
        ...
        TrolleysCoords = {
            { coords = vector3(-42.4, -1748.88, 28.42), rotation = vec3(0, 0, -270.0)},
        },
        DeliveryLocations = {
            { coords = vec3(-42.0, -1748.80, 28.42), rotation = vec3(0.0, 15.00, 0.0)},
            { coords = vec3(-42.0, -1749.05, 28.42), rotation = vec3(0.0, 15.00, 0.0)},
            { coords = vec3(-42.0, -1749.30, 28.42), rotation = vec3(0.0, 15.00, 0.0)},
            { coords = vec3(-42.0, -1749.55, 28.42), rotation = vec3(0.0, 15.00, 0.0)},
        },
        BlipCoords = vector3(-43.0, -1749.5, 29.5),
    },
    [3] = {
        rewardBonus = 0,
        isVault = false,
        ...
        TrolleysCoords = {
            { coords = vector3(380.6, 332.13, 102.57), rotation = vec3(0, 0, -270.0)},
        },
        DeliveryLocations = {
            { coords = vec3(381.0, 332.13, 102.57), rotation = vec3(0.0, 15.00, 0.0)},
            { coords = vec3(381.0, 331.88, 102.57), rotation = vec3(0.0, 15.00, 0.0)},
            { coords = vec3(381.0, 331.63, 102.57), rotation = vec3(0.0, 15.00, 0.0)},
            { coords = vec3(381.0, 331.38, 102.57), rotation = vec3(0.0, 15.00, 0.0)},
        },
        BlipCoords = vector3(380.0, 331.5, 103.5),
    },
