...
CreateThread(function()
    while true do
        if IsPushing then
            -- Bloķē lēkšanu, sišanu un tēmēšanu
            DisableControlAction(0, 22, true)  -- Lēkšana (Space)
            DisableControlAction(0, 24, true)  -- Sitieni (Peles kreisā poga)
            DisableControlAction(0, 25, true)  -- Tēmēšana (Peles labā poga)
            DisableControlAction(0, 140, true) -- Uzbrukums ar tuvcīņas ieroci
            DisableControlAction(0, 141, true) -- Otrs tuvcīņas trieciens
            DisableControlAction(0, 142, true) -- Cits tuvcīņas trieciens
            DisableControlAction(0, 257, true) -- Mērķēšana ar ieročiem
            DisableControlAction(0, 263, true) -- Tuvcīņas trieciens ar ieroci
            DisableControlAction(0, 264, true) -- Cits tuvcīņas trieciens ar ieroci
            SetPlayerCanDoDriveBy(PlayerId(), false) -- Aizliedz šaut no auto
        else
            SetPlayerCanDoDriveBy(PlayerId(), true) -- Atļauj šaut no auto
        end
        Wait(0) -- Pārliecinās, ka tas notiek katru kadru
    end
end)
