...
Config.job = { "truckerjob" }		-- Required jobs name to open the menu (set as {} to disable the permission)
...
Config.jobs = {
	...
	['cooldown'] = 45, 							-- Cooldown time (in minutes) to generate new contracts
	...
	['max_active_contracts'] = 15,				-- Maximum of contracts that can be active per page, this means that when generating a contact that exceeds this number, the oldest contract will be deleted
	['price_per_km_min'] = 20,				-- Minimum price per kilometer of the contract
	['price_per_km_max'] = 30,				-- Maximum price per kilometer of the contract
