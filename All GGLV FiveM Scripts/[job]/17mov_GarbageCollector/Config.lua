...
Config.Price = 28            -- Price per one bag inside trashmaster. 100 is maximum so full trash = 200$ / partyCount
...
Config.RequiredJob = "garbagejob"             -- Set to "none" if you dont want using jobs. If you are using target, you have to set "job" parameter inside every export in target.lua
...
Config.RewardItemsToGive = {
    {
        item_name = "recycledgoods",
        chance = 85,
        amountPerBag = 1,
    },
}

Config.EnableExploitFix = true                     -- If somebody is close to you, you'll not able to pick up bag. This will prevent exploit of copying bugs but will be also annoying
