      ...
      {cart[0] && (
        <Box className={classes.box}>
                ...
                >
                  <Image
                    src={
                      product.image
                        ? product.image
                        : `https://cfx-nui-${inventory}${product.name}.${product.extension ? product.extension : "png"}`
                    }
                    className={classes.image}
                    fallbackSrc="https://r2.fivemanage.com/QmVAYSlqeAlD4IxVbdvu5/test2.png"
                    h={100}
                    w={100}
                  />
                  <Text size="sm" fw={600}>
                  ...
                  <Text size="sm">{`${product.price * product.amount} ${
          ...
          <Box className={classes.cartList}>
            <Group
              grow
              bg="radial-gradient(circle, rgba(129, 131, 138, 0.35) 0%, rgba(63, 65, 74, 0.45) 90%)"
            ...
            <Group grow className={classes.buttons}>
              <Button variant="light" color="teal" onClick={handlePay}>
                {lang.pay}
              </Button>
